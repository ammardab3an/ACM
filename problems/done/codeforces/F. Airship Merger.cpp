// Problem: F. Airship Merger
// Contest: Codeforces - UTPC Contest 10-01-21 Div. 1 (Advanced)
// URL: https://codeforces.com/gym/103316/problem/F
// Memory Limit: 256 MB
// Time Limit: 1500 ms
// 
...
int32_t main(){
    ...
    for(int i = n-1; i >= 0; i--){
        int st_path = query(1, 0, n-1, tmp[i]+1, n-1) + 1;
        update(1, 0, n-1, tmp[i], st_path);
        ans = max(ans, st_path);
    }
