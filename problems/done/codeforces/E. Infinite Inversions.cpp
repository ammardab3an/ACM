...
// URL: https://codeforces.com/contest/540/problem/E
// Memory Limit: 256 MB
// Time Limit: 2000 ms
// 
...
int32_t main(){
    ...
    FenwickTree tree(comp.size());
    
    int ans = 0;
    for(int i = 0; i < pos.size(); i++){
        ans += tree.sum(pos[i]+1, comp.size()-1) * comp[pos[i]].second;
        tree.add(pos[i], comp[pos[i]].second);
    }
