// Problem: K. Painting Fence
// Contest: Codeforces - NAM
// URL: https://codeforces.com/gym/344772/problem/k
// Memory Limit: 512 MB
// Time Limit: 1000 ms
// 
...
int go(int l, int r, int del){
    ...
    int ndel = arr[idx]-del;
    
    return min(go(l, idx-1, del+ndel) + go(idx+1, r, del+ndel) + ndel, r-l+1);
}
